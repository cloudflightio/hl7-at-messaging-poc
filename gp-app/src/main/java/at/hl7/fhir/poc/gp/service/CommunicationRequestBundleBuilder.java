...
/**
 * Builds ATMessagingBundle with CommunicationRequest for requesting consult documents from HIS.
...
public class CommunicationRequestBundleBuilder {
    ...
    public Bundle createCommunicationRequestBundle(Patient patient, String requestDescription) {
        ...
        // Create destination endpoint (HIS - receiver)
        Endpoint destinationEndpoint = createEndpoint(hisEndpointName, hisEndpointAddress);

        // Create sender Practitioner (Dr. Huber - GP)
        Practitioner sender = createSenderPractitioner();

        // Create receiver Practitioner (Dr. Mayer - HIS)
        ...
        MessageHeader messageHeader = createMessageHeader(
                sourceEndpoint, destinationEndpoint, sender, receiver, communicationRequest, messagePatient);
        ...
        log.info("Created ATMessagingBundle with CommunicationRequest, {} entries", bundle.getEntry().size());
        return bundle;
    }
    ...
    private CommunicationRequest createCommunicationRequest(Patient patient, String description,
        ...
        request.getMeta().addProfile("http://fhir.hl7.at/fhir/ATMessaging/0.1.0/StructureDefinition/at-messaging-communication-request");
    ...
    private MessageHeader createMessageHeader(Endpoint source, Endpoint destination,
        ...
        // Definition - canonical URL to ATMessagingCommunicationRequestMessageDefinition
        messageHeader.setDefinition("http://fhir.hl7.at/fhir/ATMessaging/0.1.0/MessageDefinition/at-messaging-communicationrequest-message");
        ...
        destComponent.setName(hisEndpointName);
